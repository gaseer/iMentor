...
const Services = () => {
  ...
  return (
    <ServiceSection id="services">
      <Background ref={ref}>
        <Title className="title">Our stuffs</Title>
        <Line id="line" />
      ...
      <Content ref={addToRefs}>
        <TextBlock
          ...
          subText={
            <h5>
              We share our experience on this field and guieds youu
            </h5>
          }
        />
        <OBJ>
      ...
      <Content ref={addToRefs}>
        <TextBlock
          topic="We say"
          title={<h1>Best & Productive</h1>}
          subText={
            <h5>
             We mentor you to be the best and productive 
             for the carrier you choose.
            </h5>
          }
        />
        <OBJ>
      ...
      <Content>
        <TextBlock
          topic="Support"
          title={<h1>Together we achive big</h1>}
          subText={
            <h5>
           We help bringing together like minded people
           and form a community to share and learn from their experience.
            </h5>
          }
        />
        <OBJ>
